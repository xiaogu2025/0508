...
struct PairOpt_
{
  ...
  _other_ids_type other_ids;
   ...
   typedef  ::geometry_msgs::Point_<ContainerAllocator>  _ego_posit_type;
  _ego_posit_type ego_posit;

   typedef  ::geometry_msgs::Point_<ContainerAllocator>  _other_posit_type;
  _other_posit_type other_posit;
...
bool operator==(const ::exploration_manager::PairOpt_<ContainerAllocator1> & lhs, const ::exploration_manager::PairOpt_<ContainerAllocator2> & rhs)
{
  return lhs.from_drone_id == rhs.from_drone_id &&
    ...
    lhs.ego_posit == rhs.ego_posit &&
    lhs.other_posit == rhs.other_posit;
}
...
struct MD5Sum< ::exploration_manager::PairOpt_<ContainerAllocator> >
{
  ...
  static const uint64_t static_value1 = 0x1a32be6071621dabULL;
  static const uint64_t static_value2 = 0x5076a6dace7a9598ULL;
};
...
namespace serialization
{
  ...
  template<class ContainerAllocator> struct Serializer< ::exploration_manager::PairOpt_<ContainerAllocator> >
  {
    template<typename Stream, typename T> inline static void allInOne(Stream& stream, T m)
    {
      ...
      stream.next(m.ego_posit);
      stream.next(m.other_posit);
    }
  ...
  template<typename Stream> static void stream(Stream& s, const std::string& indent, const ::exploration_manager::PairOpt_<ContainerAllocator>& v)
  {
    ...
    for (size_t i = 0; i < v.ego_ids.size(); ++i)
    {
      if (true && i > 0)
        ...
        s << std::endl << indent << "  -";
      Printer<int8_t>::stream(s, true ? std::string() : indent + "    ", v.ego_ids[i]);
    }
    if (v.ego_ids.empty() || true)
      s << "]";
    if (true || !indent.empty())
    ...
    for (size_t i = 0; i < v.other_ids.size(); ++i)
    {
      if (true && i > 0)
        ...
        s << std::endl << indent << "  -";
      Printer<int8_t>::stream(s, true ? std::string() : indent + "    ", v.other_ids[i]);
    }
    if (v.other_ids.empty() || true)
      s << "]";
    if (true || !indent.empty())
      s << std::endl;
    s << indent << "ego_posit: ";
    Printer< ::geometry_msgs::Point_<ContainerAllocator> >::stream(s, indent + "  ", v.ego_posit);
    if (true || !indent.empty())
      s << std::endl;
    s << indent << "other_posit: ";
    Printer< ::geometry_msgs::Point_<ContainerAllocator> >::stream(s, indent + "  ", v.other_posit);
  }
};
