...
"""autogenerated by genpy from plan_env_msgs/ChunkStamps.msg. Do not edit."""
import codecs
import sys
...
int32[] ids"""
  ...
  _slot_types = ['int32','plan_env_msgs/IdxList[]','float64']
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      for i in range(0, length):
        val1 = plan_env_msgs.msg.IdxList()
        start = end
        end += 4
        (length,) = _struct_I.unpack(str[start:end])
        pattern = '<%si'%length
